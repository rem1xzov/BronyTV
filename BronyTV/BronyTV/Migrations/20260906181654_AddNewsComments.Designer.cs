...
namespace BronyTV.Migrations
{
    ...
    [Migration("20260906181654_AddNewsComments")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BronyTV.DbContext.Entity.DailyActivityProgressEntity", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<bool>("IsStreakCredited")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false);

                    b.Property<int>("QualifyingCommentsCount")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("DailyActivityProgress", "public");
                });
            ...
            modelBuilder.Entity("BronyTV.DbContext.Entity.ForumPostEntity", b =>
                {
                    ...
                    b.Property<string>("LikedUserIds")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("BronyTV.DbContext.Entity.NewsCommentEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("NewsComments", "public");
                });

            modelBuilder.Entity("BronyTV.DbContext.Entity.NewsPost", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BronyTV.DbContext.Entity.PendingManualRewardEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("PendingManualRewards", "public");
                });
            ...
            modelBuilder.Entity("BronyTV.DbContext.Entity.StreakRewardsClaimedEntity", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("UserId", "Milestone");

                    b.ToTable("StreakRewardsClaimed", "public");
                });

            modelBuilder.Entity("BronyTV.DbContext.Entity.StreamAnnouncementEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("StreamAnnouncements", "public");
                });
            ...
            modelBuilder.Entity("BronyTV.DbContext.Entity.UserEntity", b =>
                {
                    ...
                    b.Property<DateTime?>("EmailConfirmationLastSentAtUtc")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("BronyTV.DbContext.Entity.UserStreakEntity", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("FreezesMonth")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0);

                    b.Property<int>("FreezesUsedThisMonth")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0);
                    ...
                    b.Property<DateOnly?>("PendingFreezeDate")
                        .HasColumnType("date");

                    b.HasKey("UserId");

                    b.ToTable("UserStreaks", "public");
                });
            ...
            modelBuilder.Entity("BronyTV.DbContext.Entity.ForumPostEntity", b =>
                {
                    ...
                    b.HasOne("BronyTV.DbContext.Entity.ForumPostEntity", "ReplyToPost")
                        .WithMany()
            ...
            modelBuilder.Entity("BronyTV.DbContext.Entity.NewsCommentEntity", b =>
                {
                    ...
                    b.HasOne("BronyTV.DbContext.Entity.NewsPost", "News")
                        .WithMany()
                        .HasForeignKey("NewsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BronyTV.DbContext.Entity.NewsCommentEntity", "ReplyToComment")
                        .WithMany()
            ...
            modelBuilder.Entity("BronyTV.DbContext.Entity.StreamAnnouncementEntity", b =>
                {
                    b.HasOne("BronyTV.DbContext.Entity.UserEntity", "CreatedByAdmin")
                        .WithMany()
            ...
            modelBuilder.Entity("BronyTV.DbContext.Entity.UserStreakEntity", b =>
                {
                    b.HasOne("BronyTV.DbContext.Entity.UserEntity", "User")
                        .WithOne()
                        .HasForeignKey("BronyTV.DbContext.Entity.UserStreakEntity", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
